...
<div class=\"table-responsive\">
	...
	foreach ($resultado as $categoria){
		...
		//$alterar = "<a href=\"$formAlterar?id=$id&logica=alterar\" target= \"painel\">alterar</a>";
		$alterar = "<a href=\"http://localhost/view/painel.php?menuid=CDU1&id=$id&logica=alterar\" target=\"painel\">Alterar</a>";
		echo"
			<tr>
				<td>
					$nome
